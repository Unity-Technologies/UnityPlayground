...
namespace Playground.Editor.Attributes
{
    ...
    public class ResourceAttrInspector : InspectorBase
    {
        private readonly string explanation =
            "When the Player touches this object, they will collect the specified amount of this type of resource.";
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Add/Remove types")) Selection.activeObject = repository;
