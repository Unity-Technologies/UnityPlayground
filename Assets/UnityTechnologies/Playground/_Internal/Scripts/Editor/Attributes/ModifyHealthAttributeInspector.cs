...
namespace Playground.Editor.Attributes
{
    ...
    public class ModifyHealthAttributeInspector : InspectorBase
    {
        private readonly string explanation =
            "This GameObject will damage or heal other GameObjects on impact (only if they use the HealthSystemAttribute). Negative values mean damage, positive values mean healing (like a medipack).";
