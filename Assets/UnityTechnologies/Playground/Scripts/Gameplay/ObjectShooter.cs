...
namespace Playground.Gameplay
{
    ...
    public class ObjectShooter : MonoBehaviour
    {
        ...
        public Vector2 shootDirection = new(1f, 1f);
        ...
        private void Update()
        {
                ...
                && Time.time >= timeOfLastSpawn + creationRate)
            {
                Vector2 actualBulletDirection = relativeToRotation
                    ? Quaternion.Euler(0, 0, transform.eulerAngles.z) * shootDirection
                    : shootDirection;
                ...
                if (rigidbody2D != null) rigidbody2D.AddForce(actualBulletDirection * shootSpeed, ForceMode2D.Impulse);
                ...
                if (b == null) b = newObject.AddComponent<BulletAttribute>();
